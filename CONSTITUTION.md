...
- **Activiteitvoorstel** — an activiteit the AI proposes under a subthema to the leerkracht who asked, working on that subthema's subdoelen; once she or directie accepts it, it is her own activiteit (Art. IX.2). The cat also brings one unasked, on a klas's aanbod-gat.
...
- **Themabeheer** — the right, held by a few named leerkrachten or zorgcoördinatoren and given by directie (FA FR-12.2), to edit thema's with their themadoelen and kernwoordenschat, to run the FR-1 import, to work the thema-opbouw wizard, and to generate and review doelsuggesties (accept or reject them).
