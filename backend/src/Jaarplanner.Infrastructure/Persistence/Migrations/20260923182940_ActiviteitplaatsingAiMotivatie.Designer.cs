...
namespace Jaarplanner.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923182940_ActiviteitplaatsingAiMotivatie")]
    partial class ActiviteitplaatsingAiMotivatie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jaarplanner.Domain.Kat.Signaal", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Aangemaakt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("GezienOp")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateOnly?>("UitgesteldTot")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("Soort", "KlasId", "OntvangerId", "Sleutel")
                        .IsUnique();

                    b.ToTable("signalen", (string)null);
                });
            ...
            modelBuilder.Entity("Jaarplanner.Domain.Schoolcontent.Activiteitvoorstel", b =>
                {
                    ...
                    b.Property<Guid?>("ThemaplaatsingId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("KlasId", "ThemaplaatsingId");
            ...
            modelBuilder.Entity("Jaarplanner.Infrastructure.Kat.Kattik", b =>
                {
                    b.Property<DateTimeOffset>("Moment")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset>("Gestart")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("Instantie")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<DateTimeOffset?>("Voltooid")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("Moment");

                    b.ToTable("kattikken", (string)null);
                });
