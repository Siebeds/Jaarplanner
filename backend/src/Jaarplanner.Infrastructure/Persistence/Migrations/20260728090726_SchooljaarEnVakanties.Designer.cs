...
namespace Jaarplanner.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260728090726_SchooljaarEnVakanties")]
    partial class SchooljaarEnVakanties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jaarplanner.Domain.Planning.Schooljaar", b =>
                {
                    b.OwnsMany("Jaarplanner.Domain.Planning.Schoolvakantie", "_vakanties", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("schoolvakanties", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("SchooljaarId");
                        });

                    b.Navigation("_vakanties");
                });
