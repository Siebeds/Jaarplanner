...
public sealed class EfJaarplanOpslag : IJaarplanOpslag
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // The closures come with the school year (owned collection) and are what the calendar splits a thema at;
        // loading the year without them would silently yield a year with no vacations at all.
    ...
    /// on the year, and pulling the whole class/age subtree would be a large read for no consumer.
    /// </remarks>
