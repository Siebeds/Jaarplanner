...
/// per-action answers: admin may do everything whatever the lists say but edit the K3 rapportdoelen and scale (ADR-0035
/// R31), and a gebruiker holds the union of all of them. The frontend uses this to hide controls only; the server enforces.
/// </summary>
/// <param name="IsAdmin">"Admin": every action but editing the K3 rapportdoelen and the sterrenschaal (R31).</param>
/// <param name="HeeftThemabeheer">"TB".</param>
/// <param name="HeeftLeerlingzorg">
/// "Leerlingzorg" (FB-008): reads every ontwikkelingsrapport and nothing else, so it also shows the Ontwikkelingsrapport
/// tab (ADR-0035 D18).
/// </param>
...
/// leerlingen and reports they read, with no end date. Non-empty (or admin) is what shows the Ontwikkelingsrapport tab
/// (ADR-0035 D18).
/// </param>
...
/// the sterrenschaal (FB-002, <c>RapportsetBewerken</c>, D4), admin included; <paramref name="IsAdmin"/> alone does not.
/// </param>
