...
/// <summary>
/// Thin REST controller (Art. VIII) for what each hoek of a class holds while a subthema runs (FB-020, ADR-0040). All
...
/// that places a hoek and stores a subthema window, which a save may do on the way. Reads stay open, as the agenda's
/// other reads do (I9).
/// </para>
/// </summary>
[ApiController]
public sealed class HoekverrijkingenController : ControllerBase
{
    ...
    /// says so before the delete (owner, 2026-09-15). Open like the reads: it is a number, and it names no klas.
    /// </summary>
