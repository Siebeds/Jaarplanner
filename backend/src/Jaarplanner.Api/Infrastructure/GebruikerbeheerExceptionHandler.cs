...
/// jaarfase;</item>
/// <item><see cref="GebruikerbeheerConflictFout"/> → 409: a sign-in name that exists already, and the last admin
/// (ADR-0031 decision 7). Well-formed requests that the current state refuses, so not 400.</item>
/// </list>
/// The <c>Detail</c> is the fault's Dutch sentence, written for admin, who can act on it (Art. II.3 as amended
