...
/// <summary>
/// What the AI is told for one subthema and one asker (FB-025, ADR-0056). Only the school's own data: the thema, the
...
/// <para>
/// <b>The third prompt that lets the model use its own knowledge</b> (Art. IV.4, ADR-0056 A1): for an activiteit's name,
