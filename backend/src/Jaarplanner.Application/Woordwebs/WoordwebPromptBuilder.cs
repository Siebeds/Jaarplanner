...
/// <summary>
/// What the AI is told about one woordweb (FB-036, ADR-0041 W6). Only the school's own data: the subthema's name,
...
/// <para>
/// <b>The one prompt that does not forbid the model's own knowledge</b> (Art. IV.4's woordweb exception, ADR-0041 W6):
