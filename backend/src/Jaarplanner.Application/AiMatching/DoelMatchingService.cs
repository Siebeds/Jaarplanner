...
/// <summary>
/// A thema's doelsuggesties (FB-053, ADR-0052, FR-4): the AI proposes minimumdoelen as themadoel, and a person with the
...
public sealed class DoelMatchingService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var suggestie in parse.Suggesties)
        {
            ...
            // A themadoel, an open or rejected proposal (an earlier one, or this answer's own), ADR-0052 D1. A minimumdoel
            ...
            // At most eight are kept, whatever the model sends (ADR-0052 D3).
