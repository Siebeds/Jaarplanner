...
public sealed record DoelMatchResultaat
{
    ...
    /// <summary>Refs the model returned that are already a themadoel or already proposed: skipped (ADR-0052 D1).</summary>
    ...
    /// <summary>The mijlpalen those leeftijden meet, whose minimumdoelen were the candidates (ADR-0052 O3).</summary>
