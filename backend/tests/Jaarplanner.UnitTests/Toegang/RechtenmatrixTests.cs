...
public sealed class RechtenmatrixTests
{
    ...
    private static readonly Dictionary<string, string[]> Verwacht = new()
    {
        ...
        // FB-036 (ADR-0041 W2, D3): on someone else's woordweb, only directie. Every relation on her own web is the test
    ...
    // --- A woordweb (FB-036, ADR-0041): personal content, its owner's and directie's. ---
