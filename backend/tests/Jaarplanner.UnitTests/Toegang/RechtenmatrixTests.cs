...
public sealed class RechtenmatrixTests
{
    ...
    private static readonly Dictionary<string, string[]> Verwacht = new()
    {
        ...
        // FB-025 (ADR-0052 A3): on someone else's activiteitvoorstel only directie. The asker's own is its own test below.
    ...
    // --- An activiteitvoorstel (FB-025, ADR-0052 A3): its asker's while she teaches that leeftijd, and directie's. ---
