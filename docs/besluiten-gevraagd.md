...
**De projecteigenaar heeft intussen een standaard gekozen, en dat hoort u te weten.** Op 11 september 2026 besliste hij dat een leerkracht enkel de eigen klassen bewerkt en de plannen van andere klassen kan inkijken, zonder ze te kunnen wijzigen. De directie kan alles zien en aanpassen. Hoeveel andere klassen dat zijn, heeft hij niet gezegd. Voorlopig toont de tool alle andere klassen. **Uw vraag blijft open, maar niet meer op een leeg blad:** wilt u het inkijken beperken, bijvoorbeeld tot het eigen leerjaar, of wilt u het zelf kunnen instellen, zeg het dan. De tool wordt zo gebouwd dat die grens op één plaats zit en dus kan veranderen zonder herbouw.
