...
**De projecteigenaar heeft intussen een regel gekozen, en dat hoort u te weten.** Op 11 september 2026 besliste hij dat een leerkracht enkel de eigen klassen bewerkt en de plannen van andere klassen kan inkijken, zonder ze te kunnen wijzigen. Op 15 september 2026 legde hij vast welke klassen: een leerkracht kijkt de klassen van de eigen jaarfase in (bijvoorbeeld alle klassen van de derde kleuter), een hoofdleerkracht die van de jaarfase waarvoor ze aangesteld is, wie themabeheer heeft alle klassen, en wie geen klas en geen recht heeft geen enkele. Voorlopig geldt dat ook voor de klassen van vorige schooljaren; dat is een standaardkeuze, geen beslissing. De directie kan alles zien en aanpassen. **Uw vraag blijft open, maar niet meer op een leeg blad:** wilt u het inkijken ruimer (alle klassen, of per graad), nog enger, of wilt u het zelf kunnen instellen, zeg het dan. De grens zit op één plaats in de tool en kan dus veranderen zonder herbouw.
