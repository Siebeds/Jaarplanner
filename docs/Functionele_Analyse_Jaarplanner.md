...
- *(e), een zorgcoördinator, of wie geen van de vijf rechten heeft*: voorlopig niets meer dan themabeheer en Leerlingzorg (als de directie ze toekent), behalve een activiteit verwijderen die hij zelf aanmaakte en een eigen woordweb bijhouden (ADR-0041). Zonder recht kijkt hij geen klas in.
