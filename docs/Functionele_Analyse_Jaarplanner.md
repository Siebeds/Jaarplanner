...
**Een eigen woordweb** *(15-09-2026, [ADR-0041](adr/0041-eigen-woordweb-per-subthema.md))*. Elke gebruiker houdt per subthema een eigen woordweb bij, de brainstorm van stap 3 (A.7). Het hoort bij die persoon en volgt haar over de schooljaren heen. Iedereen die aanmeldt, kan elk woordweb inkijken; alleen wie het maakte en de directie wijzigen het. Wie een subthema verwijdert, verwijdert ook de woordwebs erbij. Een woordweb telt nooit mee voor de dekking.
...
- *(e), een zorgcoördinator, of wie geen van de vijf rechten heeft*: voorlopig niets meer dan themabeheer en Leerlingzorg (als de directie ze toekent), behalve een activiteit verwijderen die hij zelf aanmaakte. Zonder recht kijkt hij geen klas in.
