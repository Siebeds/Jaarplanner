...
takes the two-step route and checks the web survives. Recorded in ADR-0043 and the Art. VI.1 defaults bullet.
...
2. The amendment stated two things W1–W7 did not rule. "Outside the wizard" (IV.8, FA A.7) now reads "whether the
   wizard shows it too is E6-05's"; "every signed-in gebruiker reads every woordweb" is now default **D7** (ADR-0043,
   VI.1, FA A.11).
...
(I25) in Art. VI.1, ADR-0043, ADR-0030 §3 footnote 9 and FA A.11.
