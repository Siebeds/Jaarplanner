...
- **MSW (Mock Service Worker)** vangt in de browser elke aanvraag naar `/api` op en antwoordt met nepdata. De mocklaag
...
- **Een route zonder nabootsing antwoordt met een duidelijke fout** die methode en pad noemt, zodat een scherm nooit
  gewoon leeg lijkt.
...
- **De vaste inhoud, allemaal fictief:**
  ...
  - één thema van 4 weken met zijn minimumdoelen (echte refs uit Op.stap) en de leerplandoelen die ermee concorderen;
  - twee subthema's van 1 week voor K3, elk met een onderzoeksvraag, subdoelen (echte K3-leerplandoelen) en
  ...
  - wat de schermen verder nodig hebben om die inhoud te tonen (disciplines, doelregisters, dekking als vast getal).
...
- [ ] Gegeven een scherm dat een niet nagebootste route aanroept, dan toont het een fout die de route noemt, geen lege lijst.
