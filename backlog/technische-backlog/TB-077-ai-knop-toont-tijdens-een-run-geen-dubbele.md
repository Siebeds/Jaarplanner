...
- [x] Gegeven een AI-knop, wanneer de AI bezig is, dan staan achter het label alleen de drie huppelende puntjes, geen "…".
- [x] Gegeven een label dat op "…" eindigt in een `AiKnop`, wanneer de frontendtests lopen, dan faalt `catalogus.test.ts` met het bestand en de sleutel.
