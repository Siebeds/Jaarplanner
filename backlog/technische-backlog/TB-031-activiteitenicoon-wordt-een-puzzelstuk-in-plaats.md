...
- [ ] Gegeven de agenda op desktop, wanneer het zijpaneel smal of breed staat, dan toont de schakelaar Activiteiten een puzzelstuk naast het fiche- en het hoekicoon.
- [ ] Gegeven het geopende activiteitenpaneel, dan toont de kop hetzelfde puzzelstuk.
- [ ] Gegeven de schakelaar boven de agenda (Activiteiten, Algemene fiches, Hoekenfiches), dan toont Activiteiten hetzelfde puzzelstuk.
- [ ] Gegeven het icoon op 16 en 20 pixels, in het lichte en het donkere thema, dan is het puzzelstuk volledig zichtbaar en niet afgesneden, en blijft het verborgen voor schermlezers: het label draagt de betekenis.
- [ ] Gegeven de wijziging, dan slagen `pnpm lint` en `pnpm test`.
