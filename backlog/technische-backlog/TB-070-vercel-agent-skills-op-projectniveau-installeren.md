...
Installeer met `npx skills add vercel-labs/agent-skills` 7 van de 9 skills van het pakket op projectniveau voor
...
vercel-optimize, web-design-guidelines en writing-guidelines. De twee deployskills deploy-to-vercel en
vercel-cli-with-tokens blijven weg: deploy-to-vercel uploadt het project zonder login naar Vercel, en Jaarplanner
draait op Azure.
...
- [x] Gegeven de branch, wanneer je `.claude/skills/` bekijkt, dan staat elk van de 7 skills er als eigen map met een `SKILL.md`.
...
De skills aanpassen aan dit project, en CLAUDE.md of de constitutie wijzigen. De deployskills van het pakket
