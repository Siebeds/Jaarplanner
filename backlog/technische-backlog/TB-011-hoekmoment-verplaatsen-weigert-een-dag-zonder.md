...
Hetzelfde geldt voor hoekmomenten die vóór deze wijziging al naar een weekenddag gesleept werden: zo'n moment kan nog
naar een schooldag verplaatst worden, want de controle geldt voor de nieuwe dag, maar het kan op zijn eigen dag niet
meer verlengd of ingekort worden.
