...
- [~] **E6-02 — Role-based authorization (the ADR-0030 matrix)** — *roles ruled by the owner 2026-09-11; in progress since 2026-09-13 on `feature/e6-rollen-rechten`, **built and delivered together with E6-04** (owner ruling 2026-09-13).* Task 1, part 1 of the Art. XI amendment, is drafted on `story/E6-02-amendering` and goes to the owner for ratification after its audit rounds; no code is written before that. The owner's answers of 2026-09-13 (ADR-0030 statements 14–31 in the draft) settle (f) below the other way (doelsuggesties become directie and themabeheer only), rule I5, I7 and I8, and settle (g); this entry is rewritten with the ratification, so read the draft rather than the list below until then.
...
- [~] **E6-04 — Klassen + leerkrachten + rechten** — *in progress since 2026-09-13 on `feature/e6-rollen-rechten`, **built and delivered together with E6-02** (owner ruling 2026-09-13).* The two open items below were answered by the owner that day and are recorded in the amendment draft: a klas may have several leerkrachten (I7), and there is no separate ICT role, since directie can grant someone the directie right (g).
