...
| E3 — Jaarplan-generatie & kalender | [E3-jaarplan-kalender.md](E3-jaarplan-kalender.md) | 3 | 10 | 3 | 🚧 E3-01 + E3-05 + E3-10 done; **E3-06 next** — it is the first clickable draft directie **and teachers** assess (owner, 2026-07-29), so build it to be changed |
