 ...
 *
 * A proxy rather than a cross-origin base URL, for the same reason as the other two frontends: it
...
export default defineConfig({
  ...
  // white with no error in the app itself. Observed here on both of the other frontends.
  optimizeDeps: {
    include: [
      "react",
      "react/jsx-runtime",
