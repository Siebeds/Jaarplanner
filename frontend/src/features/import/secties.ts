 ...
 * not load Op.stap (R3, admin), so a themabeheer holder gets the one section and no switch.
 *
 ...
 * offered a way in. `beheer` is not a section's right: the beheerder is the admin right now (Art. VI.1), and
 * admin holds both of these anyway.
 */
