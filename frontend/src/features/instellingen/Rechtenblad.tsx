...
export function Rechtenblad({
  ...
  const zet = (pad: string, aan: boolean) => wijzig.mutate({ pad, aan });
      ...
      <div className="flex flex-col gap-5">
        ...
        <Groep legende={t("gebruikers.rechten")}>
          <Vinkje
            ...
            bezig={bezig}
            onZet={(aan) => zet(rechtPad.directie(id), aan)}
          />
          <Vinkje
  ...
  return (
    <div className="flex min-h-11 items-start gap-3 py-2">
      <input
        ...
        className="mt-0.5 h-5 w-5 shrink-0 cursor-pointer accent-inkt"
      />
