...
/**
 * The empty state of a screen about one klas when none is chosen (FB-013, ADR-0039).
 *
 ...
 * never tells directie they have no right. Anyone else gets the screen's own title.
 */
