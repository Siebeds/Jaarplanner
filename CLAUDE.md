...
**E1 is not complete** and **M1 is *not* reached**, for two independent reasons: E1-03/E1-04 are reopened and blocked on **E1-12** (decreed-minimumdoelen import) and **E1-21** (G goals from KOV's API): since the owner's ruling of 2026-09-11 both read KOV's Op.stap API ([ADR-0032](docs/adr/0032-opstap-api-als-importbron.md)) instead of waiting for a file from directie; E1-12 is built and wired (the DI line landed 2026-09-13) but stays open, because until E1-21 imports concorded G goals, minimumdoel-level coverage, the level the onderwijsinspectie tests, returns nothing; and **most of E1 is still not teacher-facing**. **E1-16 closed 2026-07-31** and gave E1 its first screen (the Doelen-register behind the nav item E0-10 shipped), so "E1 has no UI at all" is no longer true; both teacher-facing halves now exist: **E1-13** landed the import flow and **E1-14 closed 2026-08-04** with the thema-/activiteitenbeheer screens, in two landings and after four antagonist rondes. What still blocks **M1** is the curriculum half alone: **E1-12** (built and wired, closes with E1-21) and **E1-21** (G goals from the API). *(Rewritten 2026-09-11: this sentence said E1-12 needed the decreed file from directie, which the owner's API ruling of that day made false.)*
