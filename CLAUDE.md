...
- `node tools/backlog-board/tickets.mjs lijst | check | nummer | nieuw | status | log | blokkeer | deblokkeer | pr` — every write to a ticket goes through here (`--help` for the options)
