...
- Rights, checked server-side: directie sees and edits everything; themabeheer edits thema's, runs the FR-1 import and the wizard, and with directie alone reviews doelsuggesties; a hoofdleerkracht per (schooljaar, jaarfase) owns that jaarfase's subthema's, subdoelen and goal links; a klastoewijzing gives a klas's planning; Leerlingzorg reads every ontwikkelingsrapport.
